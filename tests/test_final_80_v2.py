...
async def test_booking_crud_comprehensive() -> None:
    ...
    from src.booking.service import get_active_services, get_service, get_free_slots, get_available_dates
    ...
    async with db.transaction() as conn:
        ...
        await conn.execute(text("INSERT INTO slots (service_id, date, start_time, end_time, is_booked) VALUES (1, '2099-12-31', '10:00', '10:30', 0)"))
        await conn.execute(text("INSERT INTO slots (service_id, date, start_time, end_time, is_booked) VALUES (1, '2099-12-31', '11:00', '11:30', 0)"))
...
def test_navigation_comprehensive() -> None:
    from src.core.navigation import NavRegistry, NavSection, escape_html, nav_header, compose_message
